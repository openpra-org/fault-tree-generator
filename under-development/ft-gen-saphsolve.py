...
gatelistGateTypeList = ['or']
gatelistNumInputsList = [3]

numGates = int(input("Number of gates in the fault tree = "))
...
for numBasicEvents in range(len(basicEventList)):
    ...
    eventList[numBasicEvents+4]['value'] = 0.01
...
with open ("demo-input-SAPHIRE.json", "w") as f:
